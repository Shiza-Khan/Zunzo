...
const HeroSection: React.FC = () => {
  return (
    <section className='w-full relative'>
      <div className="w-full min-h-[600px] flex items-center bg-no-repeat bg-cover bg-center relative bg-[url('https://thumbs.dreamstime.com/b/soccer-player-kicks-ball-wet-field-close-up-athlete-foot-orange-socks-cleats-football-match-rainy-weather-dynamic-386923077.jpg')]">
        ...
        <div className='relative z-10 max-w-2xl px-10 sm:px-16'>
          ...
          <p className='text-sm   md:text-1xl lg:text-2xl mb-6 text-white'>
            Discover the best running gear and elevate your performance. Join
            our community of passionate runners today!
          </p>
          <button
